...
#   A paper-derived top-3 answer key retained for entity recall. It is not a
#   substitute for the paper's constrained candidate universe, DepMap filtering,
#   or expert review protocol described in Supplementary Note 5.1.
#
...
AML_REPURPOSING_PAPER_TOP3 = GoldSet(
    ...
    description=(
        "Paper-derived top-3 AML answer key for entity recall. This scoring set "
        "does not reproduce the paper's ~2300 approved-drug candidate universe, "
        "DepMap filtering, or expert review stages."
    ),
    entities=[
        GoldEntity(
            name="Nanvuranlat",
