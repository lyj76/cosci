...
class RunCfg(BaseModel):
    ...
    reflection_verification_enabled: bool = True
    generation_refill_batch: int = 4
    generation_debate_every: int = 4
    generation_debate_turns: int = 4
    max_generation_attempts_multiplier: int = 2
...
class RankingCfg(BaseModel):
    ...
    position_swap_pairwise: bool = True
...
class ToolLoopCfg(BaseModel):
    ...
    tool_result_item_max_chars: int = 1_600
    tool_result_max_items: int = 6
    history_max_chars: int = 60_000
